...
class TestToDict:
    ...
    def test_with_definitions(self) -> None:
        ...
        assert d["definitions"][0] == {"name": "ema20", "type": "analyzer", "impl": "EMAAnalyzer"}
    ...
    def test_definition_with_metadata(self) -> None:
        d_def = Definition(name="t", type="a", impl="I", metadata={"key": "val"})
    ...
    def test_definition_with_id(self) -> None:
        d_def = Definition(name="t", type="a", impl="I", id="def1")
        a = Analysis(name="t", version="1.0", definitions=(d_def,))
        d = to_dict(a)
...
class TestFromDict:
    ...
    def test_definition_missing_name_raises(self) -> None:
        with pytest.raises(ValueError, match="Missing required field: name"):
            from_dict({"name": "test", "version": "1.0", "definitions": [{"type": "a", "impl": "I"}]})

    def test_parameter_missing_name_raises(self) -> None:
        with pytest.raises(ValueError, match="Missing required field: name"):
            from_dict({
                "name": "test", "version": "1.0",
                "definitions": [{"name": "d", "type": "a", "impl": "I", "parameters": [{"value": 20}]}],
            })
    ...
    def test_binding_missing_field_raises(self) -> None:
        with pytest.raises(ValueError, match="Missing required field"):
            from_dict({
                "name": "test", "version": "1.0",
                "definitions": [{"name": "d", "type": "a", "impl": "I", "bindings": [{"source": "a", "output": "x", "target": "b"}]}],
            })
...
class TestToJson:
    ...
    def test_includes_definitions(self) -> None:
        a = Analysis(
            name="test",
            version="1.0.0",
            definitions=(Definition(name="d1", type="a", impl="I"),),
        )
        s = to_json(a)
        parsed = json.loads(s)
