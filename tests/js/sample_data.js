...
const SR_DATA = [
  ...
  { time: '2024-01-04', levels: [{ price: 100, strength: 3, type: 'support' }, { price: 115, strength: 2, type: 'resistance' }] },
  { time: '2024-01-05', levels: [{ price: 100, strength: 3, type: 'support' }, { price: 115, strength: 3, type: 'resistance' }] },
  { time: '2024-01-08', levels: [{ price: 100, strength: 3, type: 'support' }, { price: 115, strength: 3, type: 'resistance' }, { price: 125, strength: 2, type: 'resistance' }] },
  { time: '2024-01-10', levels: [{ price: 100, strength: 3, type: 'support' }, { price: 115, strength: 3, type: 'resistance' }, { price: 125, strength: 3, type: 'resistance' }] },
];

const TRADES = [
  { entry_time: '2024-01-02', exit_time: '2024-01-04', entry: 108, stop: 103, target: 118, direction: 'bullish', result: 'win', pnl: 300, source: 'EMA', size: 1.0, risk_amount: 50, rr_ratio: 3.0 },
  { entry_time: '2024-01-05', exit_time: '2024-01-07', entry: 115, stop: 110, target: 130, direction: 'bullish', result: 'loss', pnl: -250, source: 'EMA', size: 1.5, risk_amount: 75, rr_ratio: 2.0 },
  { entry_time: '2024-01-08', exit_time: null, entry: 120, stop: 115, target: 135, direction: 'bullish', result: null, pnl: null, source: 'PB', size: 2.0, risk_amount: 100, rr_ratio: 3.0 },
  { entry_time: '2024-01-09', exit_time: '2024-01-10', entry: 125, stop: 120, target: 140, direction: 'bullish', result: 'breakeven', pnl: 0, source: 'PB', size: 1.0, risk_amount: 50, rr_ratio: 3.0 },
];

const PULLBACKS = [
  null,
  null,
  { time: '2024-01-03', position: 'belowBar', color: '#22c55e', shape: 'arrowUp', text: 'Pullback (1.5 ATR)' },
  null,
  null,
  null,
  null,
...
const FACTS_DATA = [
  ...
  { TREND: { type: 'trend', direction: 'bullish', strength: 0.8 }, SWINGW: { type: 'swing', timeframe: '1w', swings: [{ price: 119, index: 0, type: 'high', time: '2024-01-06' }] } },
  {},
  { TREND: { type: 'trend', direction: 'bullish', strength: 0.9 }, SWING: { type: 'swing', timeframe: '1d', swings: [{ price: 118, index: 4, type: 'high', time: '2024-01-05' }, { price: 109, index: 5, type: 'low', time: '2024-01-06' }] } },
  {},
  {},
  {},
  {},
...
const DEFAULT_OPTS = { INITIAL_BALANCE: 10000, MIN_TOUCHES: 2 };
...
module.exports = {
  CANDLES, CANDLES_BY_TF, AVAILABLE_TFS, FRAMES, EMA_SERIES,
  ATR_DATA, SR_DATA, TRADES, PULLBACKS, FACTS_DATA, makeModel,
};
