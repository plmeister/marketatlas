...
class TestLinearChain:
    """EMA(20) + ATR(14) → Trend — linear dependency chain."""
...
class TestBranching:
    ...
    def test_ema_atr_pullback_ast(self, request: pytest.FixtureRequest) -> None:
        a = (
            ...
            .define("structure", "analyzer", "SwingStructureAnalyzer")
            .with_reference("swing", "swings")
            .define("pullback", "analyzer", "PullbackPatternAnalyzer")
            .with_reference("swing_structure", "structure")
            .build()
        )
