...
class TestMarketViewSelect:
    ...
    def test_select_weekly_returns_view_with_timeframe(
        self, multi_store: MarketStore
    ) -> None:
    ...
    def test_select_weekly_current_is_weekly_candle(
        self, multi_store: MarketStore
    ) -> None:
        view = MarketView(multi_store, cursor=99, window_size=50)
        wv = view.select(Timeframe.W1)
    ...
    def test_select_weekly_history_weekly_bars(
        self, multi_store: MarketStore
    ) -> None:
        view = MarketView(multi_store, cursor=99, window_size=50)
    ...
    def test_select_weekly_prices_are_weekly_closes(
        self, multi_store: MarketStore
    ) -> None:
        view = MarketView(multi_store, cursor=99, window_size=50)
        wv = view.select(Timeframe.W1, window_size=5)
    ...
    def test_select_without_window_uses_default(
        self, multi_store: MarketStore
    ) -> None:
        view = MarketView(multi_store, cursor=99, window_size=50)
        wv = view.select(Timeframe.W1)
    ...
    def test_select_with_custom_window(
        self, multi_store: MarketStore
    ) -> None:
        view = MarketView(multi_store, cursor=99, window_size=50)
    ...
    def test_select_missing_timeframe_raises(
        self, multi_store: MarketStore
    ) -> None:
    ...
    def test_select_cursor_alignment(
        self, multi_store: MarketStore
    ) -> None:
    ...
    def test_is_valid_on_weekly_view(
        self, multi_store: MarketStore
    ) -> None:
        view = MarketView(multi_store, cursor=99, window_size=50)
        wv = view.select(Timeframe.W1, window_size=5)
        ...
        wv_bad = MarketView(
            multi_store, cursor=0, window_size=10, view_timeframe=Timeframe.W1
        )
