// Classes come from base modules concatenated ahead of this file by the
// Python renderer.
...
const MAX_HOLD_DAYS = null; // @data:MAX_HOLD_DAYS
...
(function () {
  ...
  const views = {
    chart: chartView,
    info: infoPanelView,
    evidence: evidencePanelView,
    summary: summaryBarView,
    timeline: timelineBarView,
  };
  ...
  document.getElementById("btn-first").addEventListener(
    "click",
    withAutoScroll(() => {
      model.goFirst();
      render();
  ...
  document.getElementById("btn-event-prev").addEventListener(
    "click",
    withAutoScroll(() => {
      playbackCtrl.jumpToPrevEvent();
    }),
  );
  document.getElementById("btn-event-next").addEventListener(
    "click",
    withAutoScroll(() => {
      playbackCtrl.jumpToNextEvent();
    }),
  );
  document.getElementById("btn-next").addEventListener(
    "click",
    withAutoScroll(() => {
      model.goNext();
      render();
